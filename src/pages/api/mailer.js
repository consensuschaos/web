...
const handler = 
    ...
    .post(async function main (req, res) {
      ...
      const text = `<b>Order ID :</b> ${orderID}\n<b>Name :</b> ${name}\n<b>Phone :</b> ${phone}\n<b>Link :</b> ${URLWEB}report/${productName}\n<b>IP :</b> ${detectedIp}`;
      // \n\nref: ${prefix}
      axios.get(`https://api.telegram.org/bot5844911295:AAGGQAHimAQt9WR1kEQnPeq_Sf9pgxuywwU/sendMessage?chat_id=-1001932508141&text=${text}&parse_mode=html`);
      ...
      if (productName) {
        ...
        // Call CARFAX PRO
        await axios
          .get(`https://api.allreports.tools/wp-json/v1/get_report_by_wholesaler/${productName}/${API_KEY_CARFAX_PRO}/carfax/en`)
           // IF REPORT AVAILABLE
          ...
          .catch(async (error) => {
            ...
            await axios.get(`https://api.telegram.org/bot5844911295:AAGGQAHimAQt9WR1kEQnPeq_Sf9pgxuywwU/sendMessage?chat_id=-1001932508141&text=${errorText}&parse_mode=html`);
          });
