...
const ReportSection = ({ data }) => {
  ...
  filtered = replaceAll(
    filtered,
    '="https://api.allreports.tools/wp-content/themes/apicarfaxpro/carfax/car-fax-files/css/',
    `="${URLWEB}carfax/css/vhr/`
  );
  filtered = replaceAll(
    filtered,
    '="https://api.allreports.tools/wp-content/themes/apicarfaxpro/carfax/car-fax-files/js/',
    `="${URLWEB}carfax/js/vhr/`
  );
  filtered = replaceAll(
    filtered,
    'src="https://api.allreports.tools/wp-content/themes/apicarfaxpro/carfax/car-fax-files/img/', 
